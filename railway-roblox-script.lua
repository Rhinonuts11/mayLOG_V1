...
-- mayLOG Activity API - Roblox Server Script for Railway Deployment
...
-- Configuration - UPDATE THESE VALUES FOR RAILWAY
local API_BASE_URL = "https://your-railway-app.railway.app" -- Replace with your Railway app URL
local API_TOKEN = "your_secure_token_here" -- Replace with your ACTIVITY_TOKEN from Railway
...
-- Send data to Railway API (matches mayLOG relay endpoint)
...
local function startActivityTracking()
    ...
    print("[mayLOG Activity] Railway API Endpoint:", API_BASE_URL)
...
print("[mayLOG Activity] Script loaded successfully for Railway deployment")
...
if API_BASE_URL == "https://your-railway-app.railway.app" then
    warn("[mayLOG Activity] WARNING: Please update API_BASE_URL with your Railway app URL!")
end